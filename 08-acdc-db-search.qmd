...
Scripts to process new Pandemic PACT data and update the Research Information Gateway database are available at the [`acdc-db-search`](https://github.com/ecohealthalliance/acdc-db-search) GitHub repository
