---
output-file: update-alternate-sources.html
---

# Update Alternate Sources {#update-alt-sources}

This is a summary of the previous update process for the RIG database, based on a variety of data sources. Should Pandemic PACT become unavailable as a data source in the future, these instructions can be used to download data from our alternate data sources.
